...
public class Books
{
    ...
    public List<BooksModel> GetList()
    {
        ...
        try
        {
            ...
            /*if (!String.IsNullOrEmpty(this.multiCategoryStr))
            {
                this.db.AddInParameter(com, "multiCategoryStr", DbType.String, this.multiCategoryStr);
            }
            else
            {
                this.db.AddInParameter(com, "multiCategoryStr", DbType.String, DBNull.Value);
            }
            if (!String.IsNullOrEmpty(this.multiPublisherStr))
            {
                this.db.AddInParameter(com, "multiPublisherStr", DbType.String, this.multiPublisherStr);
            }
            else
            {
                this.db.AddInParameter(com, "multiPublisherStr", DbType.String, DBNull.Value);
            }*/
            ...
            for (int i = 0; i < dsBooksList.Tables[0].Rows.Count; i++)
            {
                BookList.Add(new BooksModel()
                {
                    ...
                    BookCategoryId = Convert.ToInt32(dsBooksList.Tables[0].Rows[i]["BookCategoryId"]),
                    BookPublisherId = Convert.ToInt32(dsBooksList.Tables[0].Rows[i]["BookPublisherId"])
                });
            }
